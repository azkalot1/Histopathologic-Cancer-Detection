...
for valid_idx in range(n_groups):
    ...
    model.load_state_dict(torch.load(model_dir+'/resnet34.fold{}.best.pt'.format(valid_idx)))
    model.eval()
...
with open(r"/scratch/skolchen/cancer/results_v2/resnet34_v2.tta.Preds.pickle", "wb") as output_file:
    pickle.dump(d, output_file)
test_data['label'] = d['test_preds']
test_data.to_csv('/scratch/skolchen/cancer/results_v2/resnet34_v2.tta.csv',sep=',',index=False)